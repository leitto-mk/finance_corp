                ...
                <div class="caption">
                    <span class="caption-subject bold uppercase font-white">
                        ...
                        <div class="input-group input-large pull-right" style="margin-top: -5px">
                            ...
                            <span class="input-group-btn">
                                <a href="<?php echo site_url('FinanceCorp/add_general_journal') ?>" target="_blank" class="btn btn-md btn blue-oleo">
                            ...
                            <tbody>
                                <?php for($i =0; $i < count($list); $i++) : ?>
                                    ...
                                    <tr class="font-white sbold">
                                        ...
                                        <td align="center">
                                            <a href="<?= base_url("financecorp/edit_general_journal?docno=$docno")?>" target="_blank" type="button" class="btn btn-xs green">
                                                <i class="fa fa-edit"> </i>
                                            </a>
                                            <a href="<?php echo site_url('FinanceCorp/view_reps_general_journal?') . "docno=" . $list[$i]['DocNo'] . "&branch=" . $list[$i]['Branch'] . "&transdate=" . $list[$i]['TransDate'] . "&idnumber=" . $list[$i]['IDNumber'] ?>" target="_blank" name="report" type="button" class="btn btn-xs green-meadow">
