                            ...
                            <tbody>
                                <?php for($i =0; $i < count($list); $i++) : ?>
                                    ...
                                    <tr class="font-white sbold">
                                        ...
                                        <td align="center">
                                            <a href="<?= base_url("Cash_adv/edit_ca_receipt?docno=$docno")?>" target="_blank" type="button" class="btn btn-xs green">
                                                <i class="fa fa-edit"> </i>
                                            </a>
                                            <a href="<?=  base_url('Cash_adv/view_reps_cash_receipt?') . "docno=" . $list[$i]['DocNo'] . "&branch=" . $list[$i]['Branch'] . "&transdate=" . $list[$i]['TransDate'] ?>" target="_blank" name="report" type="button" class="btn btn-xs green-meadow">
