                            ...
                            <tbody>
                                <?php for($i =0; $i < count($list); $i++) : ?>
                                    ...
                                    <tr class="font-white sbold">
                                        ...
                                        <td align="center">
                                            <a href="<?= base_url("edit_ca_withdraw?docno=$docno")?>" target="_blank" type="button" class="btn btn-xs green">
                                                <i class="fa fa-edit"> </i>
                                            </a>
                                            <a href="<?php echo site_url('view_reps_cash_withdraw?') . "docno=" . $list[$i]['DocNo'] . "&branch=" . $list[$i]['Branch'] . "&transdate=" . $list[$i]['TransDate'] ?>" target="_blank" name="report" type="button" class="btn btn-xs green-meadow">
