                                                                ...
                                                                <div class="form-body" style="margin-top: 10px">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-3 hidden">
                                                                            <input type="text" id="m_jgrp" name="m_jgrp" class="form-control readonly" placeholder="Search.." style="background-color:white;" value=" " required>
                                                                        </div>
                                                            ...
                                                            <table class="table table-striped" id="table_detail_transaction">
                                                                <thead>
                                                                    <tr style="background-color: #22313F" class="font-white">
                                                                        <th width="4%"></th>
                                                                        <th width="20%" class="text-center"> Remarks Detail </th>
                                                                        <th width="8%" class="text-center"> Department </th>
                                                                        <th width="8%" class="text-center"> Cost Center </th>
                                                                        <th width="7%" class="text-center"> Paid To </th>
                                                                        <th width="8%" class="text-center"> Account No. </th>
                                                                        <th width="6%" class="text-center"> Currency </th>
