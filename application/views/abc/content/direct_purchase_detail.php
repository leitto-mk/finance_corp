    ...
    <div class="portlet light" style="margin-bottom: 23px;">
      ...
      <div class="portlet-body">
        ...
        <div class="form-group">
          ...
          <h4 class="so-description bold"><?= $master['Supplier'] ?></h4>
        </div>
        <div class="form-group">
  ...
  <div class="col-lg-3 col-md-6">
    <div class="portlet light">
      ...
      <div class="portlet-body">
        ...
        <?php endif; ?>
        <?php if ($master['InvoiceNo']) : ?>
          <div class="form-group">
            <label class="control-label">Invoice No</label>
            <h4 class="so-description bold"><?= $master['InvoiceNo'] ?></h4>
          </div>
        <?php endif; ?>
        <div class="form-group">
    ...
    <div class="portlet light">
      <div class="portlet-body">
        <ul class="nav nav-tabs">
          ...
          <li>
            <a href="#tab-so-invoice" class="bold uppercase" data-toggle="tab">Receive Order</a>
          </li>
        </ul>
