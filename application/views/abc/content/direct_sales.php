  ...
  <div class="page-toolbar">
    <div class="btn-group pull-right">
      ...
      <ul class="dropdown-menu pull-right" role="menu">
        <li>
          <a href="<?= site_url('abc/sales/direct_sales/new') ?>" id="action-new-directsales">
            <i class="icon-plus"></i> New Direct Sales</a>
        </li>
        <li>
  ...
  <div class="col-lg-12">
    <div class="portlet light bg-font-white">
      <div class="portlet-title">
        <div class="caption">
          <span class="caption-subject bold uppercase">Direct Sales List</span>
          <span class="caption-helper" id="portlet-report"></span>
        </div>
      </div>
      <div class="portlet-body">
        <?php $this->load->view('abc/component/table_direct_sales') ?>
      </div>
    </div>
  </div>
</div>