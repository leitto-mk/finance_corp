            ...
            <div class="page-content">
                ...
                <div class="page-head">
                    <div class="portlet light">
                        <h3 class="font-grey-gallery bold">
                            ...
                            <small class="font-yellow-casablanca"> [ <?= "$jobdesc" ?> ]</small>
                        </h3>
                    </div>
                </div>
                <!-- END PAGE HEAD-->
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 margin-bottom-20" style="margin-top: -20px">
                            ...
                            <div class="widget-bg-color-white widget-tab tabbable tabbable-tabdrop">
                                <ul class="nav nav-tabs">
                                    <li class="disable">
                                         <h4 class="caption-subject font-dark bold uppercase"><i class="fa fa-clock-o"></i> Jadwal Mengajar |</h4>
                                     </li>
                                    &nbsp;
                                    <li class="active">
