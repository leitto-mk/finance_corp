 ...
 <div class="page-footer">
    ...
    <!-- END FOOTER -->
        ...
        <script src="<?php echo base_url(); ?>assets/metronic/layouts/layout2/scripts/layout.min.js" type="text/javascript"></script>
        <script src="<?php echo base_url(); ?>assets/metronic/layouts/layout2/scripts/demo.min.js" type="text/javascript"></script>
