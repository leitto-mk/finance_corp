        ...
        <header class="page-header">
            <nav class="navbar mega-menu" role="navigation">
                <div class="container-fluid" style="margin-top: -15px">
                    <div class="clearfix navbar-fixed-top" style="padding-top: 0px; padding-bottom: 10px; background-color: #2f373e">
                        <h3 class="uppercase font-white"><a href="<?php echo site_url('Humanresource/view_personal_list'); ?>" class="dropdown-toggle font-white" title="Back" style="margin-left: -10px"><i class="icon-logout font-green"></i></a>&nbsp;&nbsp;<?php echo $headertitle ?></h3>
                        <div class="topbar-actions font-white" id="realtime_clock">
