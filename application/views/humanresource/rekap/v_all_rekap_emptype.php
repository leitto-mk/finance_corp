                                ...
                                <!-- <div id="printDiv" style="size: landscape; font-family: Open Sans, sans-serif;">   -->
                                    <div class="caption">
                                        <div class="form-body">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <h3 class="bold">Employee Type Rekap</h3>                                                    
                                                </div>
                                            </div>
                                        </div>                           
                                    </div>                                 
                                        ...
                                        <div class="col-md-3" id="printDivDet" style="size: landscape; font-family: Open Sans, sans-serif;">
                                            <div class="portlet light bg-white">
                                                <div style="float: right;">
                                                    <button class="btn btn-sm bg-blue-ebonyclay font-white hidden-print" onclick="printDivDet('printDivDet')" >Print</button>
                                                ...
                                                <div  id="printDivDet" style="size: landscape; font-family: Open Sans, sans-serif;" class="portlet-body"> 
                                                    <div class="table-responsive">
                                                        <table class="table table-bordered">
                                                            <thead>
                                                                 <?php if($r_data_emptype != null) { ?>                          
                                                                    <?php $no=1; $totalrow=0; $totalemptype=0;
                                                                    foreach($r_data_emptype as $etype) { ?>
                                                                    <?php  $totalrow = $etype->total ?>
                                                                    <?php $no++;$totalemptype+=$totalrow;} ?>    
                                                                  <?php } else { ?> 
                                                                    <?php $totalrow=0; $totalemptype=0; ?>
                                                                    <?php  $totalrow = '0' ?>
                                                                    <?php $totalemptype+=$totalrow ?>                            
                                                                  <?php } ?>  
                                                                ...
                                                                <tr class="bg-blue-madison font-white">
                                                                    ...
                                                                    <td class="text-center bold" width="60%">Employee Type
                                                                    </td>
                                                                    <td class="text-center bold" width="30%">Total = <?php echo $totalemptype; ?></td>
                                                                </tr>   
                                                            </thead>
                                                            <tbody>
                                                                <?php if($r_data_emptype != null) { ?>                          
                                                                    <?php $no=1; $totalrow2=0; $totalemptype2=0;
                                                                    foreach($r_data_emptype as $etype) { ?>    
                                                                       <tr class="font-dark">
                                                                           <td align="center"><?php echo $no; ?></td>
                                                                           <td align="left"><?php echo $etype->EmployeeTypeDes ?></td>
                                                                           <td align="center" class="bold" ><?php echo $totalrow2 = $etype->total ?></td>
                                                                       </tr>
                                                                    <?php $no++;$totalemptype2+=$totalrow2;} ?>  
                                                                <?php } else { ?>                          
                                                                    <tr>
                                                        ...
                                                        <table class="table table-bordered">
                                                           <thead>
                                                                ...
                                                                <tr class="bg-blue-madison font-white">
                                                                    ...
                                                                    <?php if($emptype != null) { ?>  
                                                                        <?php $cspan = 0;  foreach($emptype as $etype) { ?>
                                                                            <th width="15%" class="bg-blue-ebonyclay font-white"><center><?php echo $etype->EmployeeTypeDes ?></center></th>
                                                                        <?php $cspan++;} ?>
                                                                    <?php } else { ?>

                                                                    <?php } ?> 
                                                                    <th class="text-center font-white" width="3%">Total</th>                                                               
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                                <!-- <tr>
                                                                                                ...
                                                                                                <?php foreach($emptype as $etyps) { ?>
                                                                                                    <td width="15%" align="center" class="bold" style="border-top: solid 1px; border-left: solid 1px; border-right: solid 1px; border-bottom: solid 1px;">
                                                                                                        <?php foreach($dataget as $row) { ?>
                                                                                                          <?php if($row->Branch == $bus->Branch AND $row->BusinessUnit == $bus->BusinessUnit AND $row->DeptCode == $dep->DeptCode AND $row->CostCenter == $costc->CostCenter AND $row->EmployeeType == $etyps->EmployeeType) { ?>
                                                                ...
                                                                <tr style="border-top: solid 2px;" class="font-dark sbold">
                                                                    ...
                                                                    <?php } ?>  
                                                                    <td width="3%" align="center" class="bg-blue-madison"><a href="#"><font color="white"><b><?php echo $gtotal ?></b></font></a></td>
                                                                </tr>
                                                            </tbody>
                                                        </table> 
                                                    </div>
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-bordered">
                                                               <thead> 
                                                                ...
                                                                <tbody>
                                                                <?php foreach($etypest as $et){ ?>
                                                                    <!-- <tr>
                                                                       <td colspan="5"><font size="4" color="#36c6d3"><i><u><center>Input parameter first to get report</center></u></i></font></td>
                                                                   </tr> -->
                                                                   <tr>
                                                                      <td style="padding-left: 10px;" colspan="8" class="bg-grey-salsa"><font color="black"><b><?php echo $et->EmployeeTypeDes ?></b></font></td><!-- background-color: #dad9d9;"-->
                                                                    </tr>
                                                                    <?php $no = 1;
                                                                    foreach($dataetype as $dts){ ?>
                                                                        <?php if($dts->EmployeeType == $et->EmployeeType){ ?>
                                                                           <tr>
