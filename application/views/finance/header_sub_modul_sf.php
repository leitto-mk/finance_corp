...
<meta charset="utf-8" />
    ...
    <link href="<?php echo base_url(); ?>assets/jqueryui/css/jquery-ui.css" rel="stylesheet" type="text/css" />
    ...
    <link href="<?php echo base_url(); ?>assets/global/plugins/sweetalert2/dist/sweetalert2.min.css" rel="stylesheet" type="text/css" />
    <!-- END PAGE LEVEL PLUGINS -->
            ...
            <div class="page-header navbar navbar-fixed-top" style="background-color: white">
                ...
                <div class="page-header-inner ">
                    ...
                    <div class="page-logo" style="margin-left: -10px; margin-top: -10px">
                        <a href="#">
                            <h2 class="font-dark bold">Student<font color="white">_</font>Finance</h2></a>
                        <div class="menu-toggler sidebar-toggler">
                            <span></span>
                        </div>
                    </div>
                    ...
                    <div class="page-sidebar navbar-collapse collapse" style="background-color: #4d5b69">
                        <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="true" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                            ...
                            <li class="nav-head nav-item start" style="margin-top: -20px">
                                <a href="<?php echo site_url('Finance/view_dashboard'); ?>" class="nav-link nav-toggle" style="background-color: #15bed1">
                            ...
                            <li class="nav-head nav-item active">
                                ...
                                <ul class="sub-menu">
                                    <li class="nav-item start">
                                        <!-- <a href="<?php echo site_url('SDAFinance/f_entry_approval_student') ?>" target="_blank" class="nav-link"> -->
                                        <a href="<?php echo site_url('Finance/view_student_charge') ?>" class="nav-link">
                                            <!-- <i class="icon-bar-chart"></i> -->
                                            <span class="title">&bull;&nbsp;&nbsp;Student Charge</span>
                                        </a>
                                    </li>
                                    <li class="nav-item start">
                                        <a href="<?php echo site_url('Finance/view_receipt_voucher') ?>" class="nav-link">
                                            <!-- <i class="icon-bar-chart"></i> -->
                                            <span class="title">&bull;&nbsp;&nbsp;Receipt Voucher</span>
                                        </a>
                                    </li>
                                    <li class="nav-item start">
                                        <a href="<?php echo site_url('Finance/view_ar_aging_control') ?>" class="nav-link">
                                            <!-- <i class="icon-bar-chart"></i> -->
                                            <span class="title">&bull;&nbsp;&nbsp;Aged Due Control</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                            <li class="nav-head nav-item active">
                                <a href="<?php echo site_url('SDAFinance/sda_repost_journal'); ?>" class="nav-link nav-toggle" style="background-color: #44515d">
                                    <i class="fa fa-edit"></i>
                                ...
                                <ul class="sub-menu">
                                    <li class="nav-item start">
                                        <a href="#" class="nav-link">
                                            <!-- <i class="icon-bar-chart"></i> -->
                                            <span class="title">&bull;&nbsp;&nbsp;AR Aging Details</span>
                                        </a>
                                    </li>
                                    <li class="nav-item start">
                                        <a href="#" class="nav-link">
                                            <!-- <i class="icon-bar-chart"></i> -->
                                            <span class="title">&bull;&nbsp;&nbsp;AR Aging Summary</span>
                                        </a>
                                    </li>
                                    <li class="nav-item start">
                                        <a href="#" class="nav-link">
                                    ...
                                    <li class="nav-item start">
                                        <a href="#" class="nav-link">
                                            <!-- <i class="icon-bar-chart"></i> -->
                                            <span class="title">&bull;&nbsp;&nbsp;Student Ledger</span>
                                        </a>
                                    </li>
                                    <li class="nav-item start">
                                        <a href="#" class="nav-link">
                                            <!-- <i class="icon-bar-chart"></i> -->
                                            <span class="title">&bull;&nbsp;&nbsp;Matrix History</span>
                                        </a>
                                    </li>
                                    <!-- <li class="nav-item start">
                                        <a href="<?php echo site_url('SDAFinance/income_statement_journal_trans_new_fin'); ?>" target="_blank" class="nav-link">
                                            <span class="title">&bull;&nbsp;&nbsp;Income Statment</span>
                                        </a>
                                    </li> -->
                                </ul>
                            </li>
                            <li class="nav-head nav-item active">
                                ...
                                <ul class="sub-menu">
                                    <li class="nav-item start">
                                        <!-- <a href="<?php echo site_url('SDAFinance/posted_edit_delete_mast_matrix') ?>" target="_blank" class="nav-link"> -->
                                        <a href="<?php echo site_url('Finance/view_student_matrix') ?>" target="_blank" class="nav-link">
                                            <!-- <i class="icon-bar-chart"></i> -->
                                            <span class="title">&bull;&nbsp;&nbsp;Student Matrix</span>
                                        </a>
                                    </li>
                                    <li class="nav-item start">
                                        <a href="<?php echo site_url('SDAFinance/f_entry_charges_bb_student'); ?>" target="_blank" class="nav-link">
                                            <!-- <i class="icon-bar-chart"></i> -->
                                            <span class="title">&bull;&nbsp;&nbsp;Beginning Balance</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
