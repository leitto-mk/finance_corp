                        ...
                        <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="true" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                            ...
                            <li class="nav-head nav-item active">
                                ...
                                <ul class="sub-menu">
                                    <li class="nav-item start">
                                        <a href="<?php echo site_url('FinanceCorp/view_receipt_voucher') ?>" class="nav-link">
                                            <!-- <i class="icon-bar-chart"></i> -->
                                            <span class="title">&bull;&nbsp;&nbsp;Receipt Voucher</span>
                                        </a>
                                    </li>
                                    <li class="nav-item start">
                                        <a href="<?php echo site_url('FinanceCorp/view_payment_voucher') ?>" class="nav-link">
                                            <!-- <i class="icon-bar-chart"></i> -->
                                            <span class="title">&bull;&nbsp;&nbsp;Payment Voucher</span>
                                        </a>
                                    </li>
                                    <li class="nav-item start">
                                        <a href="<?php echo site_url('FinanceCorp/view_overbook_voucher') ?>" class="nav-link">
                                            <!-- <i class="icon-bar-chart"></i> -->
                                            <span class="title">&bull;&nbsp;&nbsp;Overbook Voucher</span>
                                        </a>
                                    </li>
                                    <li class="nav-item start">
                                        <a href="<?php echo site_url('FinanceCorp/view_general_journal') ?>" class="nav-link">
                                            <!-- <i class="icon-bar-chart"></i> -->
                            ...
                            <li class="nav-head nav-item active">
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li class="nav-item start">
                                        <a href="<?php echo site_url('FinanceCorp/view_gl_personal') ?>" target="_blank" class="nav-link">
                                            <!-- <i class="icon-bar-chart"></i> -->
