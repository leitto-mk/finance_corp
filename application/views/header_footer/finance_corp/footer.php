        ...
        <script type="text/javascript" src="https://cdn.jsdelivr.net/momentjs/latest/moment.min.js"></script> -->
            ...
            <!-- PERSONAL JS SCRIPTS START-->
            <script type="text/javascript">
                $('#back_main_report').on('click', function() {
                    window.location = "http://localhost/Operation_ModuleHMU/index.php/Operation/hmu";
                });
            </script>

            <!-- PERSONAL JS SCRIPTS END-->
            </body>
