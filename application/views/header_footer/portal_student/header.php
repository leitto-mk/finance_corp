        ...
        <div class="page-header navbar navbar-fixed-top bg-white">
            ...
            <div class="page-header-inner container">
                ...
                <div class="page-logo" style="margin-top: 5px">
                    <a href="#">
                        <h3 class="font-grey-mint bold uppercase">Student<font color="white">_</font>Portal</h3>
                    ...
                    <div class="top-menu">
                        <ul class="nav navbar-nav pull-right">
                            ...
                            <li class="dropdown dropdown-dark" id="header_notification_bar">
                                <a href="<?php echo site_url('Student/home'); ?>" class="dropdown-toggle">
                                    <i class="icon-home"></i>
                                </a>
                            </li>
                            ...
                            <li class="dropdown dropdown-user dropdown-dark">
                                <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                    <span class="username font-blue-oleo uppercase"> 
