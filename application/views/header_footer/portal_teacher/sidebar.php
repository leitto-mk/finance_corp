                                 ...
                                 <div class="portlet-body">
                                    <ul style="font-size: 17px; margin-left: -20px">
                                       ...
                                       <!--  <li>Service</li>
                                        ...
                                        <li  class="font-white">
                                            <a href="#" class="font-white">News & Assignment</a>
                                        </li>
                                        <li  class="font-white">
                                            <a href="#" class="font-white">My Earnings</a>
                                        </li>
                                        <li  class="font-white">
                                            <a href="#" class="font-white">Daily Input Grade</a>
                                        </li>
                                        <li  class="font-white">
                                            <a href="#" class="font-white">Input Absent</a>
                                        </li>
                                        <li  class="font-white">
                                            <a href="#" class="font-white">Scheduling</a>
                                        </li>
                                        <li  class="font-white">
                                            <a href="#" class="font-white">Student Grade</a>
                                        </li>
                                        <li  class="font-white">
                                            <a href="#" class="font-white">Recap Mid</a>
                                        </li>
                                        <li  class="font-white">
                                            <a href="#" class="font-white">Recap Absent</a>
                                        </li>
                                        <li  class="font-white">
                                            <a href="#" class="font-white">School Calendar</a>
                                        </li>
                                        <li  class="font-white">
                                            <a href="#" class="font-white">My School Asset</a>
                                        </li> 
                                        <li class="font-white">Finance</li>
                                        <ul>
                                            <li class="font-white">
                                                <a href="#">
                                                  <font size="2" color="white">My Transaction</font>
                                                </a>
                                            </li>
                                            <li class="font-white">
                                                <a href="#">
                                                  <font size="2" color="white">Cash Disbursement </font>
                                                </a>
                                            </li>
                                        </ul> 
                                        <!-- <li  class="font-white">
                                            <a href="#" class="font-white">School Activities</a>
                                        </li> -->                                    
                                    </ul>
                                </div>
                            </ul>
