                                    ...
                                    <div class="portlet-body form-horizontal">
                                        <div class="form-body" style="margin-top: 10px">
                                                ...
                                                <div class="col-md-3">
                                                    <select name="customer" id="customer" class="form-control" required>
                                                        ...
                                                        <?php for($i=0; $i < count($customers); $i++) : ?>
                                                            <?php if($customer == $customers[$i]['CustomerCode']) : ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3">
                                                    <input type="date" id="transdate" name="transdate" class="form-control" min="<?= date('Y-m-d') ?>" min="<?= date('Y-m-d') ?>" value="<?= $transdate ?>" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
