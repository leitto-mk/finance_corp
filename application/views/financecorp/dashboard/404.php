...
<html lang="en">
    ...
    <head>
        ...
        <link href="<?= base_url() ?>/assets/metronic/pages/css/error.min.css" rel="stylesheet" type="text/css" />
    ...
    <body class="page-404-3">
        <div class="page-inner">
            <!-- <img src="<?= base_url() ?>/assets/metronic/pages/media/email/abase.png" class="img-bg" alt=""> </div> -->
