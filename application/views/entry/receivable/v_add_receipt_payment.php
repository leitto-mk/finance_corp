                        ...
                        <div class="hor-menu">
                            <ul class="nav navbar-nav">
                                <li aria-haspopup="true" class="menu-dropdown classic-menu-dropdown active uppercase">
                                    <h4 style="color:#ffffff">Receipt Payment</h4>
                                </li>
                            </ul>
                        </div>
                        <!-- END MEGA MENU -->
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-3">
                                                                            <div class="input-group">
                                                                                ...
                                                                                <input type="text" name="docno" class="form-control" readonly value="" style="background-color:white;">
                                                                            </div>
                                                                        </div>
                                                                        <!-- Row 2 -->
