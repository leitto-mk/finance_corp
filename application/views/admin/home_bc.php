            ...
            <div class="page-content-row" style="background-color: white">
                ...
                <div class="page-sidebar">
                    <div class="blog-single-sidebar-tags">
                        ...
                        <ul class="blog-post-tags">
                            ...
                            <li class="font-dark">
                                <a href="#">Enrollment Management</a>
                            </li> 
                            <li class="font-dark">
                                <a href="<?php echo site_url('Admin/index'); ?>" target="_blank">School Admin</a>
                            </li> 
                            <li class="font-dark">
                    ...
                    <div class="blog-single-sidebar-tags">
                        <h3 class="blog-sidebar-title uppercase">Online</h3>
                        <ul class="blog-post-tags">
                            <li class="font-dark">
                                <a href="#">Approval</a>
                            </li>
                            ...
                            <li class="font-dark">
                                <a href="<?php echo site_url('Duty'); ?>">Book Assignment</a>
                            </li>
                            <li class="font-dark">
                                <a href="<?php echo site_url('Duty'); ?>">News & Bulletin</a>
                            </li>                            
                        </ul>
                    </div>
                    <div class="blog-single-sidebar-tags">
                    ...
                    <div class="blog-single-sidebar-tags">
                        <h3 class="blog-sidebar-title uppercase">Master</h3>
                    </div>
                    <div class="blog-single-sidebar-tags">
                ...
                <div class="page-content-col">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top: -5px;padding: 0px;">
                        <div class="portlet light bordered">
                            <div class="caption">
                                <span class="caption-subject bold uppercase font-dark">News & Assignments</span><br>
