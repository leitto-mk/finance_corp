...
<!-- <nav class="quick-nav">
    ...
    <ul>
        <li>
            <a href="<?= base_url('Admin/load_prof_std_edit') ?>">
                <span>Students</span>
                <i class="fa fa-graduation-cap"></i>
            </a>
        </li>
        <li>
            <a href="<?= base_url('Admin/load_prof_tch_edit') ?>">
                <span>Teachers</span>
                <i class="fa fa-user-tie"></i>
            </a>
        </li>
        <li>
            <a href="<?= base_url('Admin/load_prof_adm') ?>" class="active">
                <span>Profile</span>
...
<footer style="bottom: 0">
    <p class="copyright" style="padding-left: 50px;margin-top: 0px; margin-bottom: 10px; margin-left: 20px;"> Copyright &copy; <?= date('Y') ?> |
        <a target="_blank" href="http://keenthemes.com"> ABase.com</a>
    </p>
</footer>
<!-- END CONTAINER -->
...
<!-- <script src="../mod2/js/jquery.min.js" type="text/javascript"></script> -->
<!-- <script src="../mod2/js/jquery.menu.js" type="text/javascript"></script> -->
<!-- END CORE PLUGINS -->
