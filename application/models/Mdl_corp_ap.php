...
class Mdl_corp_ar extends CI_Model
{
    function get_ranged_ap($type, $datatable){
        extract($datatable);
    ...
    function get_supplier(){
        $query = $this->db->select('SupplierCode, SupplierName')->get('tbl_mat_cat_supplier')->result_array();
    ...
    function get_ap_report($type, $docno, $branch, $transdate){
        $query =  $this->db->query(
            "SELECT 
                trans.ItemNo,
                trans.DocNo,
