...
class AP extends CI_Controller {
    ...
    public function ajax_delete_ap_payment()
    {
        ...
        $this->Mdl_corp_ap->delete_existed_docno($_POST['docno']);
    ...
    public function ajax_submit_ap_payment()
    {
        ...
        $counter_beg_bal = $this->Mdl_corp_ap->get_branch_last_balance($_POST['branch'], $_POST['accno'], $_POST['transdate']);
        ...
        for ($i = 0; $i < count($_POST['itemno']); $i++) {
            ...
            if (isset($cur_accno_bal[$_POST['accnos'][$i]])) {
                ...
                $branch_beg_bal = $this->Mdl_corp_ap->get_branch_last_balance($_POST['branch'], $_POST['accnos'][$i], $_POST['transdate']);
