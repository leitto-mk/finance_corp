                        ...
                        for(let i=0; i < response.length; i++){
                            $('tbody').append(
                                `<tr class="font-white sbold">
                                    ...
                                    <td align="center">
                                        <a href="${base_url}FinanceCorp/edit_receipt?docno=${response[i].DocNo}" target="_blank" type="button" class="btn btn-xs green">
                                            <i class="fa fa-edit"> </i>
                                        </a>
                                        <a href="${base_url}FinanceCorp/view_reps_receipt_voucher?docno=${response[i].DocNo}&branch=${response[i].Branch}&transdate=${response[i].TransDate}" target="_blank" name="report" type="button" class="btn btn-xs green-meadow">
