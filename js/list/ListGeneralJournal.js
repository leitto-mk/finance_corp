                        ...
                        for(let i=0; i < response.result.length; i++){
                            $('tbody').append(
                                `<tr class="font-dark sbold">
                                    ...
                                    <td align="center">
                                        <a href="${base_url}FinanceCorp/edit_general_journal?docno=${response.result[i].DocNo}" target="_blank" type="button" class="btn btn-xs green">
                                            <i class="fa fa-edit"> </i>
                                        </a>
                                        <a href="${base_url}FinanceCorp/view_reps_general_journal?docno=${response.result[i].DocNo}&branch=${response.result[i].Branch}&transdate=${response.result[i].TransDate}" target="_blank" name="report" type="button" class="btn btn-xs green-meadow">
