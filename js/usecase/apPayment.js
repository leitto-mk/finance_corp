...
const dtColumns = [
    ...
    },
    {
        data: response => {
            return `
                <a href="${baseURL}/AP/edit_ap_payment'?docno=${response.DocNo}" target="_blank" type="button" class="btn btn-xs green">
                    <i class="fa fa-edit"> </i>
                </a>
                <a href="${baseURL}/AP/view_reps_ap_payment?docno=${response.DocNo}&branch=${response.Branch}&transdate=${response.TransDate}" target="_blank" name="report" type="button" class="btn btn-xs green-meadow">
...
const apy = {
    indexPage: {
        initDT: () => {
            ...
            repository.generateDataTable('table', 'ajax_get_ranged_ap_payment', postData, dtColumns)
        },
        ...
        eventShowList: () => {
            $('#preview, #search').click(function(){
                ...
                repository.generateDataTable('table', 'ajax_get_ranged_ap_payment', { docno, date_start, date_end }, dtColumns)
