...
const dtColumns = [
    ...
    },
    {
        data: response => {
            return `
                <a href="${baseURL}/Cash_adv/edit_ca_receipt'?docno=${response.DocNo}" target="_blank" type="button" class="btn btn-xs green">
                    <i class="fa fa-edit"> </i>
                </a>
                <a href="${baseURL}/Cash_adv/view_reps_cash_receipt?docno=${response.DocNo}&branch=${response.Branch}&transdate=${response.TransDate}" target="_blank" name="report" type="button" class="btn btn-xs green-meadow">
...
const car = {
    indexPage: {
        initDT: () => {
            ...
            repository.generateDataTable('table', 'ajax_get_ranged_ca_receipt', postData, dtColumns)
        },
        ...
        eventShowList: () => {
            $('#preview, #search').click(function(){
                ...
                repository.generateDataTable('table', 'ajax_get_ranged_ca_receipt', { docno, date_start, date_end }, dtColumns)
        ...
        eventDeleteRecord: () => {
            $(document).on('click','[name=delete]', function(){
                ...
                repository.deleteRecord('ajax_delete_ca_receipt', { docno, branch, transdate })
                .then(response => {
                    helper.unblockUI()
