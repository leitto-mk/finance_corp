            ...
            $('#btn_submit').on('click',function(e){
                ...
                .then(response => {
                    ...
                    if(response.success == true){
                        ...
                        $('#new_transaction').prop('href', window.location.origin + '/Entry/add_ar_receipt_payment')
                        $('#new_transaction').css('visibility', 'visible')
                        
                        $('#print_transaction').prop('href', window.location.origin + '/Entry/view_reps_ar_receipt_payment' + `?docno=${docno}&branch=${branch}&transdate=${transdate}`)
