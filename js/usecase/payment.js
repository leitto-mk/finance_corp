                ...
                },
                {
                    data: response => {
                        ...
                        return `
                            ...
                            <a href="${location}/Entry/view_reps_payment_voucher?docno=${response.DocNo}&branch=${response.Branch}&transdate=${response.TransDate}" target="_blank" name="report" type="button" class="btn btn-xs green-meadow">
