            ...
            columns: [
                ...
                },
                {
                    data: response => {
                        ...
                        return `
                            <a href="${location}/Entry/edit_payment?docno=${response.DocNo}" target="_blank" type="button" class="btn btn-xs green">
                                <i class="fa fa-edit"> </i>
                            </a>
                            <a href="${location}/Reports/view_reps_payment_voucher?docno=${response.DocNo}&branch=${response.Branch}&transdate=${response.TransDate}" target="_blank" name="report" type="button" class="btn btn-xs green-meadow">
            ...
            $.ajax({
                ...
                success: response => {
                    if(response.success == true){
                        ...
                        $('#print_transaction').prop('href', window.location.origin + '/Reports/view_reps_payment_voucher' + `?docno=${docno}&branch=${branch}&transdate=${transdate}`)
