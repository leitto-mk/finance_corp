    ...
    indexPage: {
        ...
        eventDeleteRecord: () => {
            $(document).on('click','[name=delete]', function(){
                ...
                repository.deleteRecord('ajax_delete_receipt', { docno, branch, transdate })
                .then(response => {
                    helper.unblockUI()
    ...
    formPage: {
        ...
        eventSubmitReceipt: () => {
            $('#btn_submit').on('click',function(e){
                ...
                let formData = $('#form_receipt_voucher').serializeArray()
                ...
                .then(response => {
                    ...
                    if(response.success == true){
                        ...
                        $('#print_transaction').prop('href', window.location.origin + '/Entry/view_reps_receipt_voucher' + `?docno=${docno}&branch=${branch}&transdate=${transdate}`)
