                ...
                },
                {
                    data: response => {
                        ...
                        return `
                            ...
                            <a href="${location}/Entry/view_reps_overbook_voucher?docno=${response.DocNo}&branch=${response.Branch}&transdate=${response.TransDate}" target="_blank" name="report" type="button" class="btn btn-xs green-meadow">
