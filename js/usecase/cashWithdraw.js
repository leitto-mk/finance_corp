            ...
            columns: [
                ...
                },
                {
                    data: response => {
                        ...
                        return `
                            <a href="${location}/Cash_adv/edit_ca_withdraw?docno=${response.DocNo}" target="_blank" type="button" class="btn btn-xs green">
                                <i class="fa fa-edit"> </i>
                            </a>
                            <a href="${location}/Reports/view_reps_cash_withdraw?docno=${response.DocNo}&branch=${response.Branch}&transdate=${response.TransDate}" target="_blank" name="report" type="button" class="btn btn-xs green-meadow">
            ...
            $.ajax({
                ...
                success: response => {
                    if(response.success == true){
                        ...
                        $('#print_transaction').prop('href', window.location.origin + '/Reports/view_reps_cash_withdraw' + `?docno=${docno}&branch=${branch}&transdate=${transdate}`)
